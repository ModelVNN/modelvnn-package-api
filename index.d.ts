...
export class modelvnnDB {
     ...
     * @example <modelvnnDB>.set("test","js is cool")
     */
     ...
     * @example <modelvnnDB>.get("test") //Will return "js is cool" (if you have set it)
     */
     ...
     * @example <modelvnnDB>.has("test") // will return true if there is a key
     */
     ...
     * @example <modelvnnDB>.delete("test")
     */
